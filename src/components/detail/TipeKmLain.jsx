const TmKmLy = ({ kost }) => {
  ...
  // const dataKamar = data.kamars.data
  // console.log(dataKamar)
  return (
    <>
      <div className="bg-slate-200 w-1/2 p-8 rounded-md">
        <div>
          <p className="text-2xl font-bold mb-7">Tipe Kamar Lainya</p>
        </div>
        <div className="flex w-9/12 m-auto ">
          {/* {dataKamar.map((kamar)=>(
            ...
            <a href="#">
              <img class="rounded-t-lg" src="/kamar.JPG" alt="" />
            </a>
            <div class="p-5">
              <a href="#">
